            ...
            <div class="content-inner">
                 ...
                 <table class="form-table">
                   <tbody>
                     <tr>
                      <td width="330">
                          <label class="labFmt100">任务名称：</label>
                       ...
                       <td>
                           <label class="labFmt80" >任务周期：</label>
                           <select class="selectFmt100"   id="runFreq"></select>
                       </td>
                       <td>
                      		<label class="labFmt100" >定时器时间点：</label>
                           <select class="selectFmt100"   id="settleFlag">
                      ...
                      <tr>
                      	<td >
                         	<label class="labFmt100">创建时间范围：</label>
                        ...
                        <td colspan="2">
                      		<label class="labFmt80">数据批次：</label>
                      		<input type="text" class="inputFmt170 dateInput" 
                            id="dateArgs" readonly="readonly" />
                      	</td>
                      	<td>
